...
Сьогодні ви переходите від авточеків до виконання справжніх домашніх завдань! Кожен пункт домашнього завдання містить як сам текст завдання, так і рекомендації та приклади.

Спочатку прочитайте текст завдання, потім вимоги та рекомендації. Вони написані таким чином, щоб підказати, на що звернути увагу при виконанні та який має бути алгоритм дій. Саме тому не слід хвилюватись — слідуйте рекомендаціям і у вас все вийде! 🔥
...
Розмістіть файли з розв'язанням у репозиторії goit-pycore-hw-03, та прикріпіть лінки до них у відповідь на домашнє завдання.
